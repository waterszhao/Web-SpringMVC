...
<center>
    ...
    <br>
    <div>
        您的位置：<a href="index.jsp">首页</a>>>新增商品信息
    </div>
    <h1>商品信息输入</h1>
    <form action="product.do" method="POST">
        <table align="center" border="0" bordercolor="red" cellpadding="5"
            ...
            <tr bgcolor="#FFE153">
                ...
                <td align='center'><input type="text" name="origin"/></td>
            </tr>
            <tr bgcolor="#FFED97">
            ...
            <tr bgcolor="#FFF4C1">
                ...
                <td align='center'><input type="text" name="inventory"/></td>
            </tr>
            <input type='hidden' name='source' value='addProduct'>
            <tr bgcolor="#FFFCEC">
