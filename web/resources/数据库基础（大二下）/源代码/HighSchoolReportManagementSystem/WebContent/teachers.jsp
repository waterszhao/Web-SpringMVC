...
<center>
    <table border="1" width="80%">
        ...
        <tr>
            ...
            <td align='center'><%=teacher.getTname()%>
            </td>
            <td align='center'><%=teacher.getTsex()%>
            </td>
            <td align='center'><%=teacher.getTage()%>
            </td>
            <td align='center'><%=teacher.getTtype()%>
            </td>
            <td align='center'><%=teacher.getTelephone()%>
            </td>
            <td align='center'><a href='checkteacher.jsp?Tno=<%=teacher.getTno() %>&&Tname=<%=teacher.getTname() %>'>查看所教课程</a>
            </td>
